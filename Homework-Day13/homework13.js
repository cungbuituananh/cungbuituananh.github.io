...
//1. Chuyển từ mảng thành chuỗi với "toString" 
let newName = ["Tuan", "Anh", "Thao", "Thang"];
newName.toString(); // "Tuan,Anh,Thao,Thang"

//2. Chuyển từ mảng thành chuỗi & có thêm dấu phân cách với "join"
let newName = ["Tuan", "Anh", "Thao", "Thang"];
newName.join("-"); // "Tuan-Anh-Thao-Thang"

//3. Xoá bỏ phần tử cuối của mảng & trả về kết quả với "pop" 
let newName = ["Tuan", "Anh", "Thao", "Thang"];
newName.pop(); // "Thang" 
newName; // Mảng chỉ còn lại ["Tuan", "Anh", "Thao"]

//4. Thêm một phần từ vào vị trí cuối cùng của mảng vứi "push"
let newName = ["Tuan", "Anh", "Thao", "Thang"];
newName.push("Nghia"); // kết quả trả về là length của array = 5
newName; // Mảng thay đổi sau khi thêm phần tử - ["Tuan", "Anh", "Thao", "Thang", "Nghia"]

//5. Ngược lại với "pop" là "shift" - loại bỏ & trả về phần tử đầu mảng 
let newName = ["Tuan", "Anh", "Thao", "Thang"];
newName.shift(); // "Tuan" 
newName; // Mảng chỉ còn lại ["Anh", "Thao", "Thang"]

//6. Tương tự như "push" là "unshift" - thêm giá trị vào đầu mảng & trả về kết quả là length của mảng. 
let newName = ["Tuan", "Anh", "Thao", "Thang"];
newName.unshift("Giang"); // trả về kết quả = 5
newName; // Mảng thay đổi = ["Giang", "Tuan", "Anh", "Thao", "Thang"]

//7. Thay đổi phần tử với chỉ mục của mảng inđex[n] 
let newName = ["Tuan", "Anh", "Thao", "Thang"]; // chỉ mục bắt đầu từ 0 đến 3 
newName[1] = "Nguyen"; // Gán giá trị mới index 1 tức vị trí số 2 của mảng
newName; // ["Tuan", "Nguyen", "Thao", "Thang"]

// Với chỉ mục của mảng cũng có thể thêm giá trị vào cuối mảng với thuộc tính length 
newName[newName.length] = "Hung"; 
newName; // ["Tuan", "Anh", "Thao", "Thang", "Hung"]

//8. Xoá phần tử của mảng bằng chỉ mục index[n]
let newName = ["Tuan", "Anh", "Thao", "Thang"];
delete newName[0];
newName; // [empty, "Anh", "Thao", "Thang"]
// p/s: xoá phần tử theo chỉ mục sẽ để lại phần tử trống trong mảng, nên cách này không được khuyến khích sử dụng như pop & shift 
